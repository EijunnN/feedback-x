...
import { Check, ChevronRight, Terminal, BarChart3, Users, Zap } from "lucide-react";
...
const NetworkBackground = () => (
  ...
  >
    ...
    <path d="M 100 300 H 700" stroke="#27272a" strokeWidth="1" strokeDasharray="4 4" />
    <path d="M 100 150 C 250 150, 250 300, 400 300" fill="none" stroke="#27272a" strokeWidth="1" />
    <path d="M 100 450 C 250 450, 250 300, 400 300" fill="none" stroke="#27272a" strokeWidth="1" />
    <path d="M 400 300 C 550 300, 550 150, 700 150" fill="none" stroke="#27272a" strokeWidth="1" />
  ...
  return (
    <div className="min-h-screen bg-black text-white selection:bg-orange-500/30 selection:text-orange-200 font-sans overflow-x-hidden">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-black/90 backdrop-blur-xl border-b border-white/5 shadow-2xl">
        <div className="container mx-auto flex h-20 items-center justify-between px-6 md:px-12">
          ...
          <nav className="hidden md:flex items-center gap-12 text-xs font-mono text-zinc-400 uppercase tracking-[0.2em] font-medium">
            <a href="#soluciones" className="hover:text-orange-500 transition-colors duration-300">
              Soluciones
            </a>
            <a href="#infraestructura" className="hover:text-orange-500 transition-colors duration-300">
              Infraestructura
            </a>
            <a href="#planes" className="hover:text-orange-500 transition-colors duration-300">
              Inversión
            </a>
          </nav>
            ...
            <SignedIn>
              <Link href="/projects">
                <button className="bg-zinc-900 border border-zinc-800 text-white px-6 py-3 text-xs font-mono font-bold uppercase tracking-widest hover:bg-zinc-800 hover:border-orange-500/50 transition-all rounded-sm flex items-center gap-2 group">
                  Panel de Control <ChevronRight className="h-3 w-3 text-orange-500 group-hover:translate-x-1 transition-transform" />
                </button>
              </Link>
            </SignedIn>
          </div>
      ...
      <main className="pt-32">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center min-h-[700px]">
            ...
            <div className="relative z-10 space-y-10">
               ...
               <p className="text-lg text-zinc-400 max-w-lg leading-relaxed border-l-2 border-orange-600 pl-6 font-light">
                  ...
                  <strong className="text-white">Annya</strong> te da la infraestructura para convertir quejas en oportunidades y sugerencias en ingresos. Sin intermediarios.
               </p>
               ...
               <div className="flex flex-col sm:flex-row gap-5 pt-4">
                  ...
                  <Button variant="outline" className="h-14 px-10 bg-transparent border-zinc-700 text-zinc-300 hover:text-white hover:bg-white/5 hover:border-white rounded-sm font-mono text-sm uppercase tracking-widest transition-all">
                        Ver Demostración
                  </Button>
               </div>
            </div>
            ...
            <div className="relative h-[600px] w-full border border-zinc-900 bg-zinc-950/50 rounded-sm overflow-hidden group shadow-2xl shadow-orange-900/10">
                ...
                <div className="absolute top-1/3 left-1/2 -translate-x-1/2 w-64 bg-zinc-900/90 backdrop-blur border border-orange-500/30 p-4 rounded-sm shadow-xl animate-[float_4s_ease-in-out_infinite]">
                    <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-[10px] font-mono text-orange-400 uppercase tracking-wider">Oportunidad Crítica</span>
                    </div>
                ...
                <div className="absolute bottom-1/4 right-10 w-56 bg-zinc-900/90 backdrop-blur border border-green-500/30 p-4 rounded-sm shadow-xl animate-[float_5s_ease-in-out_infinite_1s]">
                    <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-[10px] font-mono text-green-400 uppercase tracking-wider">Retención Mejorada</span>
                    </div>
                    <div className="text-2xl font-bold text-white font-mono">+24%</div>
                    <p className="text-[10px] text-zinc-500 uppercase mt-1">Conversión Mensual</p>
                </div>
        ...
        {/* SOLUCIONES (FEATURES) */}
        <section id="soluciones" className="py-32 container mx-auto px-6 md:px-12 bg-black relative overflow-hidden">
           {/* Fondo sutil */}
           ...
           <div className="mb-24 max-w-3xl">
              ...
              <p className="text-xl text-zinc-400 font-light leading-relaxed">
                Deje de adivinar qué quieren sus clientes. Annya le proporciona los datos crudos y procesables para iterar su producto con precisión quirúrgica.
              </p>
           </div>
           ...
           <div className="grid md:grid-cols-3 gap-8">
              {[
                  ...
                  <div key={i} className="group p-8 border border-zinc-800 bg-zinc-950/50 hover:bg-zinc-900 transition-all duration-500 hover:border-orange-500/30 rounded-sm">
        ...
        {/* CTA INTERMEDIO */}
        <section id="infraestructura" className="border-t border-zinc-900 bg-zinc-950 py-32 relative overflow-hidden">
        ...
        {/* PRICING SECTION */}
        <section id="planes" className="py-32 container mx-auto px-6 md:px-12 bg-black">
              ...
              {PLANS_DISPLAY.map((plan) => (
                ...
                >
                  ...
                  <div className="mb-10 text-center">
                    <h3 className={`font-mono text-xs uppercase tracking-[0.2em] mb-4 ${plan.highlight ? 'text-orange-400' : 'text-zinc-500'}`}>
                        Plan {plan.name}
                    </h3>
                    <div className="flex items-center justify-center gap-1">
                      <span className="text-6xl font-bold text-white tracking-tighter">{plan.price}</span>
                      <span className="text-zinc-600 font-mono text-xs self-end mb-2">/MES</span>
                    </div>
                  ...
                  <div className={`w-full h-px mb-10 ${plan.highlight ? 'bg-orange-500/20' : 'bg-zinc-800'}`} />

                  <ul className="space-y-5 mb-12 flex-1 px-2">
                    {plan.features.map((feature, i) => (
                      <li key={i} className="flex items-center gap-4 text-sm font-medium text-zinc-300">
                        <div className={`w-1.5 h-1.5 rounded-full ${plan.highlight ? 'bg-orange-500' : 'bg-zinc-600'}`} />
                        {feature}
                      </li>
                    ))}
                  </ul>
           ...
           <div className="container mx-auto px-6 md:px-12 flex flex-col md:flex-row justify-between items-center gap-8">
              <div className="flex flex-col gap-2">
                 <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-white font-bold tracking-widest text-sm">ANNYA CORP</span>
                 </div>
                 <p className="max-w-xs leading-relaxed">
                    Infraestructura de inteligencia de cliente para la próxima generación de empresas digitales.
                 </p>
              </div>
              ...
              <div className="flex gap-12 text-[10px] uppercase tracking-widest">
                  <div className="flex flex-col gap-4">
                      ...
                      <a href="#" className="hover:text-orange-500 transition-colors">Tecnología</a>
                      <a href="#" className="hover:text-orange-500 transition-colors">Seguridad</a>
                  ...
                  <div className="flex flex-col gap-4">
                      ...
                      <a href="#" className="hover:text-orange-500 transition-colors">Carreras</a>
